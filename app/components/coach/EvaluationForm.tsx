...
const EvaluationForm: React.FC<EvaluationFormProps> = ({ evaluationId,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        console.log('Form Data:', evaluationDatas);
                            ...
                            <div className="space-y-4 flex-grow">
                                {technical.map((tech) => (
                                    <div key={tech.id} className="flex items-center space-x-2">
                                        <select id={`dropdown-tech-${tech.id}`} className="border border-gray-300 rounded-md p-1 text-gray-700 text-sm w-20 " onChange={(e) => setTechnicalScores((prev) => ({
                                            ...prev,
